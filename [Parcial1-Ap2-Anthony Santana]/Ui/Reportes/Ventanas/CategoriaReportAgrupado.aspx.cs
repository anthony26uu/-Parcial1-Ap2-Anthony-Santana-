...
namespace _Parcial1_Ap2_Anthony_Santana_.Ui.Reportes.Ventanas
{
    public partial class CategoriaReportAgrupado : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSetMonto", Consultas.CCategorias.Listat));


//            this.ReportViewer1.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("DataSetMonto", Consultas.CPresupuesto.Lista));
